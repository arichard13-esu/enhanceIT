...
mv apache-hive-2.3.4-bin /usr/local/hadoop-ecosystem/hive-2.3.4-bin
cd /usr/local/hadoop-ecosystem/hive-2.3.4-bin/conf
...
echo 'export HIVE_HOME=/usr/local/hadoop-ecosystem/hive-2.3.4-bin' >> ~/.bashrc
echo 'export PATH=$PATH:$HIVE_HOME/bin' >> ~/.bashrc
source ~/.bashrc
cd /usr/local/hadoop-ecosystem/sqoop-1.4.5/lib
cp mysql-connector-java-8.0.21.jar /usr/local/hadoop-ecosystem/hive-2.3.4-bin/lib/mysql-connector-java-8.0.21.jar
cd /usr/local/hadoop-ecosystem/hive-2.3.4-bin/bin
